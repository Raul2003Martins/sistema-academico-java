...
public class UIPrincipal extends JFrame {
	...
	public UIPrincipal() throws Exception {
		...
		txtCelular.setBounds(600, 280, 140, 40);
		...
		/*btnBuscar.setIcon(
				new ImageIcon(UIPrincipal.class.getResource("/resources/buscar.png"))
			);*/
		...
		/*btnAtualizar.setIcon(
				new ImageIcon(UIPrincipal.class.getResource("/resources/atualizar.png"))
			);*/
		...
		/*btnExcluir.setIcon(
				new ImageIcon(UIPrincipal.class.getResource("/resources/apagar.png"))
			);*/
		...
		/*btnSair.setIcon(
				new ImageIcon(UIPrincipal.class.getResource("/resources/sair.png"))
			);*/
		...
		/*btnSalvar2.setIcon(
				new ImageIcon(UIPrincipal.class.getResource("/resources/save.png"))
			);*/
		btnSalvar2.setBounds(180, 280, 90, 80);
		panelNotas.add(btnSalvar2);

		JButton btnAtualizar2 = new JButton("Atualizar");
